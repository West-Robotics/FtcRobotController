...
class SussyTele : LinearOpMode() {
    ...
    override fun runOpMode() {
        ...
        // Trigger { intake.filledL }.whenActive(InstantCommand({ print("test") }))
        // Trigger { intake.filledL }.whenActive(InstantCommand({ driver.gamepad.rumble(500); operator.gamepad.rumble(500) }))
        // Trigger { intake.filledR }.whenActive(InstantCommand({ driver.gamepad.rumble(500); operator.gamepad.rumble(500) }))
        ...
        operator.lTrig.whenInactive(InstantCommand({ hang.set(HangSubsystem.State.STOP) }))
        ...
        while (opModeIsActive()) {
            ...
            Robot.write(drive, output, lift, intake, hang, drone)
        }
    }
}