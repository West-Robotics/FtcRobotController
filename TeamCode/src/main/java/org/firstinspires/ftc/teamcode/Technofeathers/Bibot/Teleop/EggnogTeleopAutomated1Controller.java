...
@TeleOp(name = "EggnogTeleopAutomated1Controller")
public class EggnogTeleopAutomated1Controller extends OpMode {
    ...
    public TechnofeathersOldDrive drive;
    ...
    @Override
    public void init() {
        drive = new TechnofeathersOldDrive(this, hardwareMap);
