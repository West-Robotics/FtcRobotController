...
@Autonomous(name="EggnogAutoNearBlue", group="Technofeathers")
public class EggnogAutoNearBlue extends LinearOpMode {
    ...
    @Override public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            */
            ...
            while(6.9 < e.seconds() && e.seconds() < 7.23) {
                drive.drive(0,0.1,0);
            }

            while(7.4 < e.seconds() && e.seconds() < 7.5) {
                drive.drive(0,0,0);
            }
