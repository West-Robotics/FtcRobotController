...
// 
// @Autonomous(name="Right Red Preload Stack", group="FifthWheel")
// public class RightRedPreloadStackAuto extends LinearOpMode {
// 
//     enum State {
//         DROPPING_PRELOAD,
//         CONE_STACK,
...
//         Pose2d lineupPose = new Pose2d(72-22.75-halfLength-1.875, -11.5, Math.toRadians(0));
// 
...
//             .lineToSplineHeading(new Pose2d(66, -11.5, Math.toRadians(0)),
...
//             .lineToSplineHeading(new Pose2d(30, -72+68, Math.toRadians(135)),
...
//             .lineToSplineHeading(new Pose2d(12, -9, Math.toRadians(90)))
//             .build();
// 
//         // TrajectorySequence signalOne = drive.trajectorySequenceBuilder(coneStack.end())
