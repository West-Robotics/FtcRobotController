...
class TeleMachines(primary: GamepadEx, secondary: GamepadEx) {
    ...
    val out = StateMachineBuilder()
                ...
                .transition({ primary.wasJustPressed(GamepadKeys.Button.LEFT_BUMPER) }, OutputSubsystem.OutputState.PREPOOP_L)
                .transition({ secondary.wasJustPressed(GamepadKeys.Button.DPAD_DOWN) }, OutputSubsystem.OutputState.READY)
                .state(OutputSubsystem.OutputState.PLOP_R)
                .transition({ primary.wasJustPressed(GamepadKeys.Button.LEFT_BUMPER) }, OutputSubsystem.OutputState.PREPOOP_R)
                ...
                .transition({ primary.wasJustPressed(GamepadKeys.Button.LEFT_BUMPER) }, OutputSubsystem.OutputState.POOP_R)
                .transition({ secondary.wasJustPressed(GamepadKeys.Button.DPAD_LEFT) }, OutputSubsystem.OutputState.READY)
