    ...
    fun getOutMachine(primary: GamepadEx, secondary: GamepadEx): StateMachine {
        return StateMachineBuilder()
                ...
                .state(OutputSubsystem.OutputState.READY)
                        ...
                        .transition({ secondary.wasJustPressed(GamepadKeys.Button.DPAD_UP) }, OutputSubsystem.OutputState.PLOP_READY)
                ...
                .state(OutputSubsystem.OutputState.PLOP_READY)
                        .onEnter { secondary.gamepad.rumbleBlips(2) }
                ...
                .state(OutputSubsystem.OutputState.PLOP_L)
                        .transition({ primary.wasJustPressed(GamepadKeys.Button.A) }, OutputSubsystem.OutputState.PREPOOP_L)
                        .transition({ secondary.wasJustPressed(GamepadKeys.Button.DPAD_DOWN) }, OutputSubsystem.OutputState.READY)
                .state(OutputSubsystem.OutputState.PLOP_R)
                        .transition({ primary.wasJustPressed(GamepadKeys.Button.A) }, OutputSubsystem.OutputState.PREPOOP_R)
                        .transition({ secondary.wasJustPressed(GamepadKeys.Button.DPAD_DOWN) }, OutputSubsystem.OutputState.READY)
                .state(OutputSubsystem.OutputState.PREPOOP_L)
                        .transition({ primary.wasJustPressed(GamepadKeys.Button.A) }, OutputSubsystem.OutputState.POOP_R)
                        .transition({ secondary.wasJustPressed(GamepadKeys.Button.DPAD_DOWN) }, OutputSubsystem.OutputState.READY)
                .state(OutputSubsystem.OutputState.PREPOOP_R)
                        .transition({ primary.wasJustPressed(GamepadKeys.Button.A) }, OutputSubsystem.OutputState.POOP_R)
                        .transition({ secondary.wasJustPressed(GamepadKeys.Button.DPAD_DOWN) }, OutputSubsystem.OutputState.READY)
                .state(OutputSubsystem.OutputState.POOP_L)
                        .transition({ secondary.wasJustPressed(GamepadKeys.Button.DPAD_DOWN) }, OutputSubsystem.OutputState.READY)
