...
// 
// @Autonomous(name="Left Red Preload Stack", group="FifthWheel")
// public class LeftRedPreloadStackAuto extends LinearOpMode {
// 
//     enum State {
//         DROPPING_PRELOAD,
//         CONE_STACK,
...
//             .lineToSplineHeading(new Pose2d(-30, -72+65, Math.toRadians(45)),
...
//             .lineToSplineHeading(new Pose2d(-16, -9, Math.toRadians(90)))
//             .build();
// 
//         // TrajectorySequence signalThree = drive.trajectorySequenceBuilder(coneStack.end())
//         //     .splineToLinearHeading(new Pose2d(36, -38, Math.toRadians(90)), Math.toRadians(90))
