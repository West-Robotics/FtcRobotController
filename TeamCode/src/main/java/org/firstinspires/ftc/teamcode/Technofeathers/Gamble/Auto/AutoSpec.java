...
public class AutoSpec extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        moveForward(600,0.3);
        verticalLeftLift.setTargetPosition(-1200);
        verticalRightLift.setTargetPosition(-1200);
        verticalRightLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        verticalLeftLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        verticalLeftLift.setPower(0.5);
        verticalRightLift.setPower(0.5);
        ...
        verticalLeftLift.setTargetPosition(-800);
        verticalRightLift.setTargetPosition(-800);
        verticalRightLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        verticalLeftLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        verticalLeftLift.setPower(0.3);
        verticalRightLift.setPower(0.3);
        while(opModeIsActive()&&verticalRightLift.isBusy()||verticalLeftLift.isBusy()){
            idle();
        }
        verticalLeftLift.setPower(0);
        ...
        verticalLeftLift.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        moveForward(210,0.3);
        verticalLeftLift.setTargetPosition(-1650);
        verticalRightLift.setTargetPosition(-1650);
        verticalRightLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        verticalLeftLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        verticalLeftLift.setPower(1);
        verticalRightLift.setPower(1);
        while(opModeIsActive()&&verticalRightLift.isBusy()||verticalLeftLift.isBusy()){
            idle();
        }
        verticalLeftLift.setPower(0);
        ...
        verticalLeftLift.setTargetPosition(80);
        verticalRightLift.setTargetPosition(80);
        verticalRightLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        verticalLeftLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
